...
1. # 개발 환경👨‍💻
   <img src="/readme_img/firstproject_stack.png" width="100%">   
  
1. # 주요 기능

   1. ## Client와 Server의 분리
        <br>
        <img src="/readme_img/client_server.png" style="border:3px solid black;border-radius:9px;width:200px">
        <table style="border:2px solid black"><tr><td>
   ...
   1. ## 맵 약국 정보를 출력 / 경로 탐색 기능   
      ...
      <table style="border:2px solid black">
        <tr>
        <td><img src="/readme_img/PHARM_map_weekday_weekend.gif" width="300px"></td>
        <td><img src="/readme_img/PHARM_map_path_draw.gif" width="300px"></td>
        </tr>
      </table>
   ...
   1. ## 맵 검색 기능   
      ...
      <table style="border:2px solid black">
        <tr>
        <td><img src="/readme_img/PHARM_map_search.gif" width="300px"></td>
        </tr>
      </table>
